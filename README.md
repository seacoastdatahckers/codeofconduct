# Welcome to the Seacoast Data Hackers Slack Team.

## Introduction
This community is a complement to the [Meetup group](http://www.meetup.com/Seacoast-ME-NH-Data-Science-Meetup/), Slack room and the mailing lists and seeks to provide a safe, friendly community for participants to interact with one another.
...
-Seacoast Data Hackers Slack Administrative Team
...
The Seacoast Data Hackers Slack Team is dedicated to providing a harassment-free experience for everyone, regardless of (but not limited to): gender, gender identity and expression, sexual orientation, disability, physical appearance, body size, race, age, religion, or preferred technological ecosystem.


We do not tolerate harassment of Slack participants in any form. Sexual language and imagery is not appropriate for any venue. Slack participants violating these rules may be sanctioned or expelled from the Seacoast Data Hackers Slack at the discretion of the Administrative Team.
...
If a participant engages in harassing behaviour, the Administrative Team retain the right to take any actions to keep the event a welcoming environment for all participants, including warning the offender or expulsion of the offender from the Seacoast Data Hackers Slack.
